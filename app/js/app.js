         ...
         */
                ...
                link: function($scope, element, attrs) {
                    ...
                    $scope.searchChanged = function() {
                        if (
                            $scope.inputLabel.labelFilter.length <
                                vMinSearchLength &&
                    ...
                    $scope.updateFilter = function() {
                        ...
                        for (i = $scope.inputModel.length - 1; i >= 0; i--) {
                            ...
                            if (
                                typeof $scope.inputModel[i][
                                    attrs.groupProperty
                                ] !== "undefined" &&
                                $scope.inputModel[i][attrs.groupProperty] ===
                                    false
                            ) {
                            ...
                            if (
                                ...
                                if (
                                    typeof attrs.searchProperty !==
                                        "undefined" &&
                                    attrs.searchProperty !== ""
                                ) {
                                    for (var key in $scope.inputModel[i]) {
                                        if (
                                            typeof $scope.inputModel[i][key] !==
                                                "boolean" &&
                                            String($scope.inputModel[i][key])
                                                .toUpperCase()
                                                .indexOf(
                                                    $scope.inputLabel.labelFilter.toUpperCase()
                                                ) >= 0 &&
                                            attrs.searchProperty.indexOf(key) >
                                                -1
                                        ) {
                                            gotData = true;
                                            break;
                            ...
                            if (
                                ...
                                if (
                                    typeof $scope.filteredModel[
                                        $scope.filteredModel.length - 1
                                    ][attrs.groupProperty] !== "undefined" &&
                                    $scope.filteredModel[
                                        $scope.filteredModel.length - 1
                                    ][attrs.groupProperty] === false
                                ) {
                        ...
                        $timeout(function() {
                            ...
                            if (
                                ...
                                angular.forEach($scope.filteredModel, function(
                                    value,
                                    key
                                ) {
                    ...
                    $scope.syncItems = function(item, e, ng_repeat_index) {
                        ...
                        if (
                            ...
                            for (
                                ...
                                if (
                                    typeof $scope.filteredModel[i][
                                        attrs.groupProperty
                                    ] !== "undefined" &&
                                    $scope.filteredModel[i][
                                        attrs.groupProperty
                                    ] === true
                                ) {
                    ...
                    $scope.refreshOutputModel = function() {
                        ...
                        if (typeof attrs.outputProperties !== "undefined") {
                            ...
                            angular.forEach($scope.inputModel, function(
                                value,
                                key
                            ) {
                                if (
                                    typeof value !== "undefined" &&
                                    typeof value[attrs.groupProperty] ===
                                        "undefined" &&
                                    ...
                                    var index = $scope.outputModel.push(
                                        tempObj
                                    );
                                    delete $scope.outputModel[index - 1][
                                        $scope.indexProperty
                                    ];
                                    delete $scope.outputModel[index - 1][
                                        $scope.spacingProperty
                    ...
                    $scope.toggleCheckboxes = function(e) {
                        ...
                        angular
                            .element(document)
                            .off("keydown", $scope.keyboardListener);
                        ...
                        if (angular.element(checkBoxLayer).hasClass("show")) {
                            ...
                            if (
                                typeof formElements[$scope.tabIndex] !==
                                "undefined"
                            ) {
                        ...
                        // open
                            ...
                            angular
                                .element(document)
                                .on("keydown", $scope.keyboardListener);
                            ...
                            if (typeof helperContainer !== "undefined") {
                                for (
                                    var i = 0;
                                    i <
                                    helperContainer.getElementsByTagName(
                                        "BUTTON"
                                    ).length;
                                    i++
                                ) {
                            ...
                            if (element[0].querySelector(".inputFilter")) {
                                element[0]
                                    ...
                                    .focus();
                                $scope.tabIndex =
                                    $scope.tabIndex + helperItemsLength - 2;
                                // blur button in vain
                                angular
                                    .element(element)
                                    .children()[0]
                            ...
                            // if there's no filter then just focus on the first checkbox item
                                ...
                                if (!$scope.isDisabled) {
                                    $scope.tabIndex =
                                        $scope.tabIndex + helperItemsLength;
                    ...
                    $scope.keyboardListener = function(e) {
                        ...
                        // next element ( tab, down & right key )
                            ...
                            while (
                                formElements[$scope.tabIndex].disabled === true
                            ) {
                                $scope.tabIndex++;
                                if ($scope.tabIndex > formElements.length - 1) {
                                    $scope.tabIndex = 0;
                    ...
                    if (typeof attrs.translation !== "undefined") {
                        ...
                        $scope.lang.reset = $sce.trustAsHtml(
                            $scope.icon.reset +
                                "&nbsp;&nbsp;" +
                                $scope.translation.reset
                        );
                        $scope.lang.search = $scope.translation.search;
                        $scope.lang.nothingSelected = $sce.trustAsHtml(
                    ...
                    $scope.icon.tickMark = $sce.trustAsHtml(
                        $scope.icon.tickMark
                    );
                    ...
                    if (
                        ...
                        vMinSearchLength = Math.floor(
                            parseInt(attrs.MinSearchLength)
                        );
                    }
                    ...
                    $scope.$on("$destroy", function() {
                        angular
                            .element(document)
                            .unbind("touchstart", onTouchStart);
                        angular
                            .element(document)

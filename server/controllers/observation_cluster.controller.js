const observation_cluster = require("../models/index").observation_cluster;
...
const create = async (req, res) => {
    const observationClusterObj = await observation_cluster.create({
...
const load = async (req, res, next, id) => {
    const observationClusterObj = await observation_clusters.findById(
        req.params.observationClusterId
    );
